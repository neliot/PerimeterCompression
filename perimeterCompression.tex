...
The experimental results will show the effects on the swarm in terms of both inter-agent distances and also the magnitude metric~\cite{eliot2018metric} generated between each agent.

========= MORE WORK ON THIS SECTION REQUIRED ==
