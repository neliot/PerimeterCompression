...
\begin{split}
n_r(b) = & \{b' \in S~:\\
&((b' \neq b) \land \mathsf{per}(b)\wedge \mathsf{per}(b')\wedge\magn{bb'} <= k_{rpc}R_b) \\
&\vee\\ 
&((b' \neq b )\land \neg(\mathsf{per}(b)\wedge \mathsf{per}(b'))\wedge\magn{bb'} <= R_b)\\
&\}
\end{split}
\end{flalign}
...
\begin{split}
n_r(b) = & \{b' \in n_r(b)~:\\
&(\mathsf{per}(b)\wedge \mathsf{per}(b')\wedge\magn{bb'} <= k_{rpc}R_b) \\
&\vee\\ 
&(\neg(\mathsf{per}(b)\wedge \mathsf{per}(b'))\wedge\magn{bb'} <= R_b)\\
&\}
\end{split}
