...
\begin{equation}\label{eq:rep7}
	v_r(b) = \frac{1}{\card{n_r(b)}}\sum_{b' \in n_r(b)} \mathsf{ekr}(b,b') \left(\magn{\vbb{b}{b'}} - R_b \, \right) \widehat{\left(\vbb{b}{b'}\right)}
\end{equation}
