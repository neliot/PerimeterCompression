...
For a given agent pair their perimeter status will be calculated and applied to the matrices. If both agents are perimeter based then the values selected would be $\rb[P_b,P_b']\Rightarrow 0.8$ and $\kr[P_b,P_b']\Rightarrow 335$. If the agent pair were perimeter->non-perimeter then the values selected would be $\rb[P_b,P_b']\Rightarrow 2$ and $\kr[P_b,P_b']\Rightarrow 67$.\\
