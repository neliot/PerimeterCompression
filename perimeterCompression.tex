...
\begin{figure}[H]
	...
	\end{center}
	\caption{Tight Perimeter stabilised configuration. \label{fig:tightPerimMagnitude}}
\end{figure}
...
\begin{figure}[H]
	...
	\end{center}
	\caption{Baseline 2 stabilised configuration. \label{fig:perimExpandMagnitude}}
\end{figure}
